...
const debug_annotation = @import("../../perfetto/trace/track_event/debug_annotation.proto.zig");
const source_location = @import("../../perfetto/trace/track_event/source_location.proto.zig");
const track_event = @import("../../perfetto/trace/track_event/track_event.proto.zig");
const task_execution = @import("../../perfetto/trace/track_event/task_execution.proto.zig");
const log_message = @import("../../perfetto/trace/track_event/log_message.proto.zig");
const chrome_compositor_scheduler_state = @import("../../perfetto/trace/track_event/chrome_compositor_scheduler_state.proto.zig");
const chrome_user_event = @import("../../perfetto/trace/track_event/chrome_user_event.proto.zig");
const chrome_keyed_service = @import("../../perfetto/trace/track_event/chrome_keyed_service.proto.zig");
const chrome_legacy_ipc = @import("../../perfetto/trace/track_event/chrome_legacy_ipc.proto.zig");
const chrome_histogram_sample = @import("../../perfetto/trace/track_event/chrome_histogram_sample.proto.zig");
const chrome_latency_info = @import("../../perfetto/trace/track_event/chrome_latency_info.proto.zig");
const chrome_frame_reporter = @import("../../perfetto/trace/track_event/chrome_frame_reporter.proto.zig");
const chrome_application_state_info = @import("../../perfetto/trace/track_event/chrome_application_state_info.proto.zig");
const chrome_renderer_scheduler_state = @import("../../perfetto/trace/track_event/chrome_renderer_scheduler_state.proto.zig");
const chrome_window_handle_event_info = @import("../../perfetto/trace/track_event/chrome_window_handle_event_info.proto.zig");
const chrome_content_settings_event_info = @import("../../perfetto/trace/track_event/chrome_content_settings_event_info.proto.zig");
const chrome_active_processes = @import("../../perfetto/trace/track_event/chrome_active_processes.proto.zig");
const screenshot = @import("../../perfetto/trace/track_event/screenshot.proto.zig");
const chrome_message_pump = @import("../../perfetto/trace/track_event/chrome_message_pump.proto.zig");
const chrome_mojo_event_info = @import("../../perfetto/trace/track_event/chrome_mojo_event_info.proto.zig");
// enums
