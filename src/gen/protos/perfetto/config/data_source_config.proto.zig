...
const ftrace_config = @import("ftrace/ftrace_config.proto.zig");
const inode_file_config = @import("inode_file/inode_file_config.proto.zig");
const process_stats_config = @import("process_stats/process_stats_config.proto.zig");
const sys_stats_config = @import("sys_stats/sys_stats_config.proto.zig");
const heapprofd_config = @import("profiling/heapprofd_config.proto.zig");
const java_hprof_config = @import("profiling/java_hprof_config.proto.zig");
const android_power_config = @import("power/android_power_config.proto.zig");
const android_log_config = @import("android/android_log_config.proto.zig");
const gpu_counter_config = @import("gpu/gpu_counter_config.proto.zig");
const android_game_intervention_list_config = @import("android/android_game_intervention_list_config.proto.zig");
const packages_list_config = @import("android/packages_list_config.proto.zig");
const perf_event_config = @import("profiling/perf_event_config.proto.zig");
const vulkan_memory_config = @import("gpu/vulkan_memory_config.proto.zig");
const track_event_config = @import("track_event/track_event_config.proto.zig");
const android_polled_state_config = @import("android/android_polled_state_config.proto.zig");
const android_system_property_config = @import("android/android_system_property_config.proto.zig");
const statsd_tracing_config = @import("statsd/statsd_tracing_config.proto.zig");
const system_info_config = @import("system_info/system_info_config.proto.zig");
const frozen_ftrace_config = @import("ftrace/frozen_ftrace_config.proto.zig");
const chrome_config = @import("chrome/chrome_config.proto.zig");
const v8_config = @import("chrome/v8_config.proto.zig");
const interceptor_config = @import("interceptor_config.proto.zig");
const network_trace_config = @import("android/network_trace_config.proto.zig");
const surfaceflinger_layers_config = @import("android/surfaceflinger_layers_config.proto.zig");
const surfaceflinger_transactions_config = @import("android/surfaceflinger_transactions_config.proto.zig");
const android_sdk_sysprop_guard_config = @import("android/android_sdk_sysprop_guard_config.proto.zig");
const etw_config = @import("etw/etw_config.proto.zig");
const protolog_config = @import("android/protolog_config.proto.zig");
const android_input_event_config = @import("android/android_input_event_config.proto.zig");
const pixel_modem_config = @import("android/pixel_modem_config.proto.zig");
const windowmanager_config = @import("android/windowmanager_config.proto.zig");
const system_metrics = @import("chrome/system_metrics.proto.zig");
const kernel_wakelocks_config = @import("android/kernel_wakelocks_config.proto.zig");
const gpu_renderstages_config = @import("gpu/gpu_renderstages_config.proto.zig");
const histogram_samples = @import("chrome/histogram_samples.proto.zig");
const app_wakelock_config = @import("android/app_wakelock_config.proto.zig");
const cpu_per_uid_config = @import("android/cpu_per_uid_config.proto.zig");
