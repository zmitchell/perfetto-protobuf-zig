...
const batt_metric = @import("android/batt_metric.proto.zig");
const cpu_metric = @import("android/cpu_metric.proto.zig");
const mem_metric = @import("android/mem_metric.proto.zig");
const mem_unagg_metric = @import("android/mem_unagg_metric.proto.zig");
const package_list = @import("android/package_list.proto.zig");
const ion_metric = @import("android/ion_metric.proto.zig");
const fastrpc_metric = @import("android/fastrpc_metric.proto.zig");
const lmk_metric = @import("android/lmk_metric.proto.zig");
const powrails_metric = @import("android/powrails_metric.proto.zig");
const startup_metric = @import("android/startup_metric.proto.zig");
const unsymbolized_frames = @import("android/unsymbolized_frames.proto.zig");
const java_heap_stats = @import("android/java_heap_stats.proto.zig");
const java_heap_histogram = @import("android/java_heap_histogram.proto.zig");
const java_heap_class_stats = @import("android/java_heap_class_stats.proto.zig");
const lmk_reason_metric = @import("android/lmk_reason_metric.proto.zig");
const hwui_metric = @import("android/hwui_metric.proto.zig");
const display_metrics = @import("android/display_metrics.proto.zig");
const task_names = @import("android/task_names.proto.zig");
const surfaceflinger = @import("android/surfaceflinger.proto.zig");
const gpu_metric = @import("android/gpu_metric.proto.zig");
const jank_cuj_metric = @import("android/jank_cuj_metric.proto.zig");
const hwcomposer = @import("android/hwcomposer.proto.zig");
const g2d_metric = @import("android/g2d_metric.proto.zig");
const dma_heap_metric = @import("android/dma_heap_metric.proto.zig");
const trace_quality = @import("android/trace_quality.proto.zig");
const profiler_smaps = @import("android/profiler_smaps.proto.zig");
const multiuser_metric = @import("android/multiuser_metric.proto.zig");
const simpleperf = @import("android/simpleperf.proto.zig");
const camera_metric = @import("android/camera_metric.proto.zig");
const dvfs_metric = @import("android/dvfs_metric.proto.zig");
const network_metric = @import("android/network_metric.proto.zig");
const camera_unagg_metric = @import("android/camera_unagg_metric.proto.zig");
const rt_runtime_metric = @import("android/rt_runtime_metric.proto.zig");
const irq_runtime_metric = @import("android/irq_runtime_metric.proto.zig");
const binder_metric = @import("android/binder_metric.proto.zig");
const android_frame_timeline_metric = @import("android/android_frame_timeline_metric.proto.zig");
const android_blocking_calls_cuj_metric = @import("android/android_blocking_calls_cuj_metric.proto.zig");
const monitor_contention_metric = @import("android/monitor_contention_metric.proto.zig");
const android_sysui_notifications_blocking_calls_metric = @import("android/android_sysui_notifications_blocking_calls_metric.proto.zig");
const codec_metrics = @import("android/codec_metrics.proto.zig");
const io_metric = @import("android/io_metric.proto.zig");
const io_unagg_metric = @import("android/io_unagg_metric.proto.zig");
const anr_metric = @import("android/anr_metric.proto.zig");
const monitor_contention_agg_metric = @import("android/monitor_contention_agg_metric.proto.zig");
const android_boot = @import("android/android_boot.proto.zig");
const ad_services_metric = @import("android/ad_services_metric.proto.zig");
const sysui_notif_shade_list_builder_metric = @import("android/sysui_notif_shade_list_builder_metric.proto.zig");
const sysui_update_notif_on_ui_mode_changed_metric = @import("android/sysui_update_notif_on_ui_mode_changed_metric.proto.zig");
const app_process_starts_metric = @import("android/app_process_starts_metric.proto.zig");
const android_boot_unagg = @import("android/android_boot_unagg.proto.zig");
const android_garbage_collection_unagg_metric = @import("android/android_garbage_collection_unagg_metric.proto.zig");
const auto_metric = @import("android/auto_metric.proto.zig");
const android_blocking_calls_unagg = @import("android/android_blocking_calls_unagg.proto.zig");
const android_oom_adjuster_metric = @import("android/android_oom_adjuster_metric.proto.zig");
const android_broadcasts_metric = @import("android/android_broadcasts_metric.proto.zig");
const wattson_in_time_period = @import("android/wattson_in_time_period.proto.zig");
const android_anomaly_metric = @import("android/android_anomaly_metric.proto.zig");
const wattson_tasks_attribution = @import("android/wattson_tasks_attribution.proto.zig");
const android_garbage_collection_stats = @import("android/android_garbage_collection_stats.proto.zig");
const clone_duration = @import("common/clone_duration.proto.zig");
const android_blocking_calls_cuj_per_frame_metric = @import("android/android_blocking_calls_cuj_per_frame_metric.proto.zig");
// structs
